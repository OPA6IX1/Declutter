...
<<<<<<< HEAD
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-8 py-2 ">
              <p className="text-[14px] md:text-[16px] font-[poppins] font-[400] text-white text-center opacity-70">Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%!</p>
              
              <div className="flex justify-center mt-8 gap-70 ">
                <p className="text-[18px]  md:text-[16px] font-[poppins] font[600] text-white">
=======
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-8 py-2">
...
=======
                <p className="flex mb-8  text-[16px] md:text-[18px] font-[poppins] font[400] text-white ">
                English<RiArrowDropDownLine size={20}/>
>>>>>>> Opa6ix
                </p>
              </div>
            </div>
